...
sudo echo 'preparing miniconda for arm64 and x68_64 for conda build on osx'
...
if [ ! -d prepare_miniconda_packages ] ; then
    ...
    curl -L https://repo.anaconda.com/miniconda/Miniconda3-latest-MacOSX-x86_64.sh -o prepare_miniconda_packages/miniconda3_x68_64.sh
...
rm -rf miniconda3_x68_64
mkdir -p miniconda3_x68_64
bash prepare_miniconda_packages/miniconda3_x68_64.sh -b -u -p ~/miniconda3_x68_64
source miniconda3_x68_64/bin/activate
conda update -y -n base -c defaults conda
conda deactivate
