...
async def serve(
    ...
    try:
        ...
        tasks = [
            ...
            if t not in (asyncio.current_task(), g_serve_task)]
...
def run(
    ...
    global g_serve_task
    if g_serve_task:
        raise ServerError('A server instance is already running.')
    ...
    try:
        ...
        loop.run_until_complete(g_serve_task)
