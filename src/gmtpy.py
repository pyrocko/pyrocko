...
_gmt_defaults_by_version['5.1.1'] = r'''
#
...
#
DIR_DATA                        = 
DIR_DCW                         = /usr/local/src/dcw-gmt-1.1.1
DIR_GSHHG                       = /usr/local/src/gshhg-gmt-2.3.2
DIR_TMP                         = 
DIR_USER                        = 
#
# FONT Parameters
...
def get_gmt_version(gmtdefaultsbinary, gmthomedir):
    ...
    if not m:
        p = subprocess.Popen(['gmt', '--version'], stderr=subprocess.PIPE,
