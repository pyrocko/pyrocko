...
g_nat_colors = {
    'nat_green1':      (94, 102,  80),
    'nat_green2':     (143, 150, 125),
    'nat_brown':      (180, 157, 132),
    'nat_gray':        (95,  85,  83),
    'nat_yellow':     (199, 187,   0),
    'nat_blue':         (0, 101, 153),
    'nat_acc_blue':     (0, 179, 236),
    'nat_acc_purple': (131,  33,  93),
    'nat_acc_yellow': (199, 187,   0),
    'nat_acc_orange': (238, 178,   0),
    'nat_acc_gray':    (95,  85,  83)}

g_named_colors = {}

g_named_colors.update(g_tango_colors)
g_named_colors.update(g_standard_colors)
g_named_colors.update(g_nat_colors)
