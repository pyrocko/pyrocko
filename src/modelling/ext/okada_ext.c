...
static void ua(double xi, double et, double q, double disl1, double disl2,
               double disl3, c0_t* c0, c2_t* c2, double* u) {
  /*
...
static void ub(double xi, double et, double q, double disl1, double disl2,
               double disl3, c0_t* c0, c2_t* c2, double* u) {
  /*
  ...
  double ai1, ai2, ai3, ai4, aj1, aj2, aj3, aj4, aj5, aj6, ak1, ak2, ak3, ak4,
      d11, qx, qy, rd, rd2, x, xy;
  double du[12];
...
static void uc(double xi, double et, double q, double z, double disl1,
               double disl2, double disl3, c0_t* c0, c2_t* c2, double* u) {
  /*
  ...
  double c, cdr, h, ppy, ppz, qq, qqy, qqz, qr, qy, x53, xy, y0, y53, yy0, z0,
      z32, z53;
  double du[12];
  ...
  c = c2->d + z;
  x53 = (8.0 * c2->r2 + 9.0 * c2->r * xi + 3.0 * c2->xi2) * c2->x11 * c2->x11 *
        c2->x11 / c2->r2;
  y53 = (8.0 * c2->r2 + 9.0 * c2->r * et + 3.0 * c2->et2) * c2->y11 * c2->y11 *
        c2->y11 / c2->r2;
  h = q * c0->cd - z;
  ...
  if (disl1 != 0.0) {
    ...
    du[1] = c0->alp4 * (c0->cd / c2->r + 2.0 * qy * c0->sd) -
            c0->alp5 * c * q / c2->r3;
    ...
    du[8] = -c0->alp4 * q / c2->r3 + yy0 * c0->sd +
            c0->alp5 * (cdr * c0->cd + c * c2->d * qr -
                        (y0 * c0->cd + q * z0) * c0->sd);
    du[9] = c0->alp4 * xi * ppz * c0->cd - c0->alp5 * xi * qqz;
    du[10] = c0->alp4 * 2.0 * (c2->y / c2->r3 - y0 * c0->cd) * c0->sd +
             c2->d / c2->r3 * c0->cd -
             c0->alp5 * (cdr * c0->cd + c * c2->d * qr);
    du[11] = yy0 * c0->cd - c0->alp5 * (cdr * c0->sd - c * c2->y * qr -
                                        y0 * c0->sdsd + q * z0 * c0->cd);
    for (i = 0; i < 12; i++) {
      u[i] += disl1 / (2. * M_PI) * du[i];
    }
  }
  ...
  if (disl2 != 0.0) {
    ...
    du[7] = c0->alp4 * (c2->x11 - c2->y * c2->y * c2->x32) -
            c0->alp5 * c *
                ((c2->d + 2.0 * q * c0->cd) * c2->x32 - c2->y * et * q * x53);
    du[8] = xi * ppy * c0->sd + c2->y * c2->d * c2->x32 +
            c0->alp5 * c *
                ((c2->y + 2.0 * q * c0->sd) * c2->x32 - c2->y * c2->q2 * x53);
    du[9] = -q / c2->r3 + y0 * c0->sdcd -
            c0->alp5 * (cdr * c0->cd + c * c2->d * qr);
    du[10] = c0->alp4 * c2->y * c2->d * c2->x32 -
             c0->alp5 * c *
                 ((c2->y - 2.0 * q * c0->sd) * c2->x32 + c2->d * et * q * x53);
    du[11] = -xi * ppz * c0->sd + c2->x11 - c2->d * c2->d * c2->x32 -
             c0->alp5 * c *
                 ((c2->d - 2.0 * q * c0->cd) * c2->x32 - c2->d * c2->q2 * x53);
    for (i = 0; i < 12; i++) {
      u[i] += disl2 / (2. * M_PI) * du[i];
    }
  }
  ...
  if (disl3 != 0.0) {
    ...
    du[7] = -c0->alp4 * 2.0 * xi * ppy * c0->sd - c2->y * c2->d * c2->x32 +
            c0->alp5 * c *
                ((c2->y + 2.0 * q * c0->sd) * c2->x32 - c2->y * c2->q2 * x53);
    du[8] =
        -c0->alp4 * (xi * ppy * c0->cd - c2->x11 + c2->y * c2->y * c2->x32) +
        c0->alp5 *
            (c * ((c2->d + 2.0 * q * c0->cd) * c2->x32 - c2->y * et * q * x53) +
             xi * qqy);
    du[9] = -et / c2->r3 + y0 * c0->cdcd -
            c0->alp5 * (z / c2->r3 * c0->sd - c * c2->y * qr - y0 * c0->sdsd +
                        q * z0 * c0->cd);
    du[10] = c0->alp4 * 2.0 * xi * ppz * c0->sd - c2->x11 +
             c2->d * c2->d * c2->x32 -
             c0->alp5 * c *
                 ((c2->d - 2.0 * q * c0->cd) * c2->x32 - c2->d * c2->q2 * x53);
    du[11] =
        c0->alp4 * (xi * ppz * c0->cd + c2->y * c2->d * c2->x32) +
        c0->alp5 *
            (c * ((c2->y - 2.0 * q * c0->sd) * c2->x32 + c2->d * et * q * x53) +
             xi * qqz);
    for (i = 0; i < 12; i++) {
      u[i] += disl3 / (2. * M_PI) * du[i];
    }
...
static okada_error_t dccon2(double xi, double et, double q, double c0_sd,
                            double c0_cd, int kxi, int ket, c2_t* c2) {
  /*
...
static okada_error_t dc3d(double alpha, double x, double y, double z,
  ...
  if (q == 0.0 && ((xi[0] * xi[1] <= 0.0 && et[0] * et[1] == 0.0) ||
                   (et[0] * et[1] <= 0.0 && xi[0] * xi[1] == 0.0))) {
    return SINGULAR;
  }
...
void rot_vec31(double vecin[3], double rotmat[3][3], double vecrot[3]) {
  /*
...
void rot_tensor33(double tensin[3][3], double rotmat[3][3],
                  double tensrot[3][3]) {
  /*
...
void rot_tensor33_trans(double tensin[3][3], double rotmat[3][3],
                        double tensrot[3][3]) {
  /*
   * Apply Rotation on tensor
   * Rotation of a 3x3 tensor with a 3x3 rotation matrix
...
void rot_u(double uin[12], double rotmat[3][3], double uout[12]) {
...
void euler_to_matrix(double alpha, double beta, double gamma,
                     double rotmat[3][3]) {
  double ca = cos(alpha);
  double cb = cos(beta);
  double cg = cos(gamma);
...
static okada_error_t dc3d_flexi(
    ...
    double disl2, double disl3, double* u, int rot_sdn) {
  /*
   *   Wrapper for dc3d function
   *   It is applied on single source-receiver pair for an arbitrary oriented
   * source Displacement and strain at depth due to buried finite fault in a
   *    semiinfinite medium.
   *
   *    Input:
   *
   ...
   *      ns, es, zs:  coordinate of source plane reference point north, east,
   * down [m] strike:      strike-angle (degree) dip:         dip-angle (degree)
   *      al1, al2:    fault length range
   *      aw1, aw2:    fault width range
   *      disl1-disl3: strike-, dip-, tensile-dislocations
   *      rot_sdn:     1, if displacements and derivatives are returned in
   * strike-dip- tensile (normal), 0 for north-east-down Output:
   *
   *      u[12]: displacement (units of disl) and derivatives
  ...
  iret = dc3d(alpha, rrot[0], rrot[1], rrot[2], ds, dip, al1, al2, aw1, aw2,
              disl1, disl2, disl3, uokada);
...
int halfspace_check(double* source_patches, double* receiver_coords,
                    unsigned long nsources, unsigned long nreceivers) {
  /*
  ...
  for (isrc = 0; isrc < nsources; isrc++) {
    src_idx = isrc * 9;
    if ((source_patches[src_idx + 2] - sin(source_patches[src_idx + 4] * D2R) *
                                           source_patches[src_idx + 7]) < 0 ||
        (source_patches[src_idx + 2] - sin(source_patches[src_idx + 4] * D2R) *
                                           source_patches[src_idx + 8]) < 0) {
      PyErr_Format(PyExc_ValueError,
                   "Source %g, %g, %g (N, E, D) is (partially) above "
                   "z=0.\nCalculation was terminated. Please check.",
                   source_patches[src_idx], source_patches[src_idx + 1],
                   source_patches[src_idx + 2]);
      return 0;
    }
  ...
  for (irec = 0; irec < nreceivers; irec++) {
    if (receiver_coords[irec * 3 + 2] < 0) {
      PyErr_Format(PyExc_ValueError,
                   "Receiver %g, %g, %g (N, E, D) is above z=0.\nCalculation "
                   "was terminated.  Please check!",
                   receiver_coords[irec * 3], receiver_coords[irec * 3 + 1],
                   receiver_coords[irec * 3 + 2]);
      return 0;
    }
  }
  return 1;
...
static PyObject* w_dc3d_flexi(PyObject* m, PyObject* args, PyObject* kwds) {
  ...
  PyObject *source_patches_arr, *source_disl_arr, *receiver_coords_arr,
      *output_arr;
  ...
  static char* kwlist[] = {"source_patches_arr",
                           "source_disl_arr",
                           "receiver_coords_arr",
                           "lambda",
                           "mu",
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwds, "OOOdd|Iii", kwlist,
                                   &source_patches_arr, &source_disl_arr,
                                   &receiver_coords_arr, &lambda, &mu,
                                   &nthreads, &rot_sdn, &stack_sources)) {
    PyErr_SetString(
        st->error,
        "usage: okada(source_patches_arr, disl_arr, receiver_coords_arr, "
        "lambda, mu, nthreads=0, rotate_sdn=False, stack_sources=True)");
    return NULL;
  }
  ...
  shape_want[1] = 9;
  if (!good_array(source_patches_arr, NPY_FLOAT64, 2, shape_want)) return NULL;

  shape_want[1] = 3;
  if (!good_array(source_disl_arr, NPY_FLOAT64, 2, shape_want)) return NULL;

  shape_want[0] = nrec;
  if (!good_array(receiver_coords_arr, NPY_FLOAT64, 2, shape_want)) return NULL;
...
#pragma omp parallel shared(nrec, nsources, lambda, mu, receiver_coords,      \
                                source_patches, source_disl, output, rot_sdn) \
    private(uout, irec, isource, i, alpha) num_threads(nthreads)
  {
#pragma omp for schedule(static)
    ...
    for (irec = 0; irec < nrec; irec++) {
      for (isource = 0; isource < nsources; isource++) {
        ...
        dc3d_flexi(
            alpha, receiver_coords[irec * 3], receiver_coords[irec * 3 + 1],
            receiver_coords[irec * 3 + 2], source_patches[isource * 9],
            source_patches[isource * 9 + 1], source_patches[isource * 9 + 2],
            source_patches[isource * 9 + 3], source_patches[isource * 9 + 4],
            source_patches[isource * 9 + 5], source_patches[isource * 9 + 6],
            source_patches[isource * 9 + 7], source_patches[isource * 9 + 8],
            source_disl[isource * 3], source_disl[isource * 3 + 1],
            source_disl[isource * 3 + 2], uout, rot_sdn);
...
static PyObject* w_patch2m6(PyObject* m, PyObject* args, PyObject* kwds) {
  ...
  PyObject *strike_arr, *dip_arr, *rake_arr, *disl_shear_arr, *disl_norm_arr,
      *output_arr;
  ...
  static char* kwlist[] = {"strikes",    "dips",      "rakes",
                           "disl_shear", "disl_norm", "lamb",
                           "mu",         "nthreads",  NULL};

  if (!PyArg_ParseTupleAndKeywords(
          args, kwds, "OOOOOOO|I", kwlist, &strike_arr, &dip_arr, &rake_arr,
          &disl_shear_arr, &disl_norm_arr, &lambda_arr, &mu_arr, &nthreads)) {
    PyErr_SetString(st->error,
                    "usage: patch2m6(strikes, dips, rakes, disl_shear, "
                    "disl_norm, lambda, mu, nthreads=1)");
    return NULL;
  }
  ...
  shape_want[0] = nsources;
  if (!good_array(strike_arr, NPY_FLOAT64, 1, shape_want)) return NULL;

  if (!good_array(dip_arr, NPY_FLOAT64, 1, shape_want)) return NULL;

  if (!good_array(rake_arr, NPY_FLOAT64, 1, shape_want)) return NULL;

  if (!good_array(disl_shear_arr, NPY_FLOAT64, 1, shape_want)) return NULL;

  if (!good_array(disl_norm_arr, NPY_FLOAT64, 1, shape_want)) return NULL;

  if (!good_array(lambda_arr, NPY_FLOAT64, 1, shape_want)) return NULL;

  if (!good_array(mu_arr, NPY_FLOAT64, 1, shape_want)) return NULL;
  ...
  if (nsources / nthreads <= 250) nthreads = 1;

  Py_BEGIN_ALLOW_THREADS
#pragma omp parallel shared(nsources, lambda, mu, strike, dip, rake, \
                                disl_norm, disl_shear, output)       \
    private(mom_in, mom_out, isource) num_threads(nthreads)
  {
#pragma omp for schedule(static)
#endif
    for (isource = 0; isource < nsources; isource++) {
      euler_to_matrix(dip[isource] * D2R, strike[isource] * D2R,
                      -rake[isource] * D2R, rotmat);

      // Apparently it is faster when we always set the sparse indices to 0.
      // ~10%
...
static PyMethodDef okada_ext_methods[] = {
    {"okada", (PyCFunction)(void (*)(void))w_dc3d_flexi,
     METH_VARARGS | METH_KEYWORDS,
     PyDoc_STR("Calculates the static displacement and its derivatives from "
               "Okada Source")},
    {"patch2m6", (PyCFunction)(void (*)(void))w_patch2m6,
     METH_VARARGS | METH_KEYWORDS,
     PyDoc_STR("Converts shear and normal dislocation to rotated m6 moment "
...
PyMODINIT_FUNC PyInit_okada_ext(void)

{
  ...
  st->error = PyErr_NewException("pyrocko.modelling.okada_ext.OkadaExtError",
                                 NULL, NULL);
  if (st->error == NULL) {
    Py_DECREF(module);
    INITERROR;
  ...
  Py_INCREF(st->error);
  PyModule_AddObject(module, "pyrocko.modelling.okada_ext.OkadaExtError",
                     st->error);
