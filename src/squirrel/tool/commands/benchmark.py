...
headline = 'Benchmark waveform reading speed.'
...
def setup(parser):
    ...
    parser.add_argument(
        ...
        metavar='DURATION',
        default=3600.,
        help='Set processing time interval [s].')

    method_choices = ['chopper', 'files', 'raw']
    ...
    parser.add_argument(
        ...
        metavar='METHOD',
        default='chopper',
        help='Benchmark method to perform. Choices: %s'
        % ldq(method_choices))
