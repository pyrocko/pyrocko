...
from .model import to_kind_id, WaveformOrder, to_kind, to_codes, \
    ...
    codes_patterns_for_kind, merge_codes
...
class Batch(object):
    ...
    *Attributes:*
    ...
    def as_carpet(
        ...
        if codes is None:
            codes = merge_codes(component_codes, 'replace_deep')
...
class Squirrel(Selection):
    ...
    **Method summary**
    ...
    def get_waveforms(
            ...
            load_data=True, accessor_id='default', order_only=False,
            channel_priorities=None, tscale_min=None, downloads_enabled=True):
    ...
    def chopper_waveforms(
            ...
            accessor_id=None, clear_accessor=True, group_by=None,
            channel_priorities=None, downloads_enabled=True):
    ...
    def kind_provides(self):
        return ('waveform', 'channel', 'response', 'carpet', 'event')
