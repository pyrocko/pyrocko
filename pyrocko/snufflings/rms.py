...
class RootMeanSquareSnuffling(Snuffling):
    ...
    def call(self):
        ...
        rms_by_nslc = {}
        for traces in self.chopper_selected_traces(tinc=tinc, want_incomplete=False, fallback=True):
            for tr in traces:
                ...
                # create a trace of required length if none has been initialized yet
