...
def read_channel_header(f, npad=4):
    ...
    sta, cha1, loc1, cha2, ear, loc2, doy, net1, mon, net2, day, hr, min, tflag, \
            secs, rate, nsamples, lat, lon, elevation, gain_flag, sample_bytes, response_flag1, response_flag2  \
            = unpack_fixed('a5,a2,a1,a1,i3,a1,i3,a1,i2,a1,i2,x1,i2,x1,i2,a1,f6,x1,f7,i7,x1,f8?,x1,f9?,x1,f5?,a1,i1,a1,a1', d[:79])
    ...
    return (net, sta, loc, cha, tmin, tflag, deltat, nsamples, sample_bytes, lat, lon, elevation, gain)

def read_channel_data(f, endianness, sample_bytes, nsamples, gain, load_data=True, npad=4):
    if not load_data:
