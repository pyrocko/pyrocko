...
sudo apt-get install -y python-pyqt5 python-pyqt5.qtwebengine python-pyqt5.qtopengl python-pyqt5.qtsvg
sudo apt-get install -y python-future python-requests
